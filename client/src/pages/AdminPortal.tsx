...
export const AdminPortal: React.FC = () => {
  ...
  // Products state for admin management
          ...
          <div className="max-w-7xl mx-auto flex items-center justify-between flex-wrap gap-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[10px] text-slate-400 font-mono">Malta Fulfillment Node • Restricted Access</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                onClick={logout}
                className="flex items-center gap-1.5 px-3.5 py-1.5 bg-red-600/20 hover:bg-red-600/30 text-red-400 hover:text-red-300 rounded-xl text-xs font-bold border border-red-500/30 transition-colors"
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col justify-between selection:bg-red-500 selection:text-white relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-md w-full mx-auto px-4 py-8">
        <div className="bg-slate-900/90 backdrop-blur-xl rounded-3xl border border-slate-800 p-7 sm:p-8 shadow-2xl shadow-black/80 space-y-6">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-xs text-slate-400">
              Authorized access for DESI BOLT dispatch, live orders, fleet, and inventory.
            </p>
          </div>
          ...
          {isCustomerLoggedIn && (
            <div className="p-3.5 rounded-2xl bg-amber-500/10 border border-amber-500/30 text-amber-300 text-xs space-y-1">
              ...
              <p className="text-[11px] text-amber-200/80">
                You are currently signed in as a Customer. Please sign in with an Administrator account to access this console.
              </p>
            </div>
          )}
          ...
          <form onSubmit={handleAdminLogin} className="space-y-4">
            ...
            <button
              ...
              className="w-full py-3 bg-red-600 hover:bg-red-500 disabled:bg-slate-800 text-white text-xs font-black rounded-xl shadow-lg shadow-red-600/30 transition-all flex items-center justify-center gap-2"
            >
              {isSubmitting ? (
                <>
