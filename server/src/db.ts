  ...
  private seedInitialData() {
    const sampleProducts: Product[] = [
      ...
      },
      {
        ...
        rating: 4.9,
        reviewCount: 290,
        description: 'Soft melt-in-the-mouth cottage cheese and milk solid dumplings soaked in rose syrup.',
        origin: 'India',
        isVegetarian: true,
        isBestSeller: true,
        vatRate: 0.18,
      ...
      },
      {
        ...
        rating: 5.0,
        reviewCount: 210,
        description: 'Traditional golden granulated cow ghee with rich natural aroma.',
        origin: 'India',
        isVegetarian: true,
        isBestSeller: true,
        vatRate: 0,
      ...
      },
      {
        ...
        rating: 4.9,
        reviewCount: 220,
        description: 'Unique blend of Kashmiri and red chillies providing vibrant glowing red color.',
        origin: 'India',
        isVegetarian: true,
        isBestSeller: true,
        vatRate: 0,
